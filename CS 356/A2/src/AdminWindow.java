  ...
  private class Handler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (e.getSource() == addUserButton) {
        ...
        User newUser = new IndividualUser(userId);
      ...
      if (e.getSource() == addGroupButton) {
        ...
        User newUserGroup = new GroupUser(groupId);
        if (groupId.isEmpty()) {
          return;
        }
      ...
      if (e.getSource() == openUserViewButton) {
        ...
        if (e.getSource() == showPositiveWordsButton) {
          ...
          popUp.infoBox(String.format("%.02f", positivePercentage.result()) + "% of messages are positive.", "Positive Percentage of Messages");
        }
      }
    }
  }
